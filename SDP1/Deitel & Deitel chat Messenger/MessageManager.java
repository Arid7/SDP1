...
public interface MessageManager {   
    // connect to message server and route incoming messages to given MessageListener                             
    public void connect( MessageListener listener );        
      
    // disconnect from message server and stop routing incoming messages to given MessageListener      
